...
public class ClassField {
		...
		public String toString() {
			return "ClassField [sqlLine=" + sqlLine + ", fieldName=" + fieldName + ", sqlFieldName=" + sqlFieldName
					+ ", dataType=" + dataType + ", sqlDataType=" + sqlDataType + ", annotations=" + annotations
					+ ", rightComment=" + rightComment + ", topComment=" + topComment + ", importStr=" + importStr
					+ "]";
		}
